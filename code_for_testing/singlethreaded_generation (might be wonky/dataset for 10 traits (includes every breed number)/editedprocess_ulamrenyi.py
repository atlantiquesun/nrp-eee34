...
times_to_test=1000
number_of_datapoints=16234423423423
for reliability in reliabilities_to_test:
    for i in range(10,11):#generate until 16 traits
        f = open(('reliability_{0}_data_traits_{1}_{2}_times_ulamrenyi.csv'.format(reliability,i,times_to_test)), 'w')
